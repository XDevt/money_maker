...
import '../styles/AddNewFinanceAccount.css';
  ...
  return (
    <div className="add-new-fin-account-container">
      ...
      <div className={`add-new-fin-account-modal-content ${modalVisible ? 'visible' : ''}`}>
        ...
        <div class="add-new-fin-account-grid-container">
          ...
          <div className="add-new-fin-account-grid-item" onClick={() => handleBackspace()}>
            <img alt="" src="/static/images/create_fin_account/backspace-button.svg" />
          </div>
          ...
          <div className="add-new-fin-account-grid-item-tall-item" onClick={operation ? handleEqualClick : closeModalWithSavings}>
            {operation ? "=" : <img alt="" src="/static/images/create_fin_account/save_change_button.svg" />}
          </div>
      ...
      <div className="add-new-fin-account-header">
          ...
          />
          <span className="add-new-fin-account-title">Новый счёт</span>
        </div>
      ...
      <div className="add-new-fin-account-create-button-container" onClick={handleCreateAccountClick}>
          <button className="add-new-fin-account-create-button">Создать</button>
      </div>
