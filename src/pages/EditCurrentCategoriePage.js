...
function EditCurrentCategoriePage() {
  ...
  const handleSaveCurrencies = (currency) => {
    ...
    return (
        <div className="edit-current-categorie-page">
        ...
        <div class="add-new-fin-account-grid-container">
          ...
          <div class="add-new-fin-account-grid-item" onClick={() => handleDecimalClick()}>.</div>
            ...
            <div className="categories-statistic-header">
              ...
              />
              <p className="categories-statistic-title">Изменить категорию</p>
            </div>
            ...
            <div className="add-new-categorie-create-button-container">
                      <button className="add-new-categorie-create-button">Сохранить</button>
            </div>

            <div className="edit-current-categorie-delete-button-container">
                      <button className="edit-current-categorie-delete-button">Удалить</button>
            </div>
...
export default EditCurrentCategoriePage;